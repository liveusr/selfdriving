...
dist_sensor_data_t  periodic_dist_data = {14, 13, 12, 11};
other_sensor_data_t periodic_other_data = {17, 19};
...
class periodicDistTask : public scheduler_task
{
    public:
        ...
        {
            setRunDuration(31); // in milliseconds
        }
...
class periodicOtherTask : public scheduler_task
{
    public:
        ...
        {
            setRunDuration(1031); // in milliseconds
        }
