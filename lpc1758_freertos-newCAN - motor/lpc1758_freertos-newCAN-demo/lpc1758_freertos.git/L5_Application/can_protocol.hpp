...
typedef struct {
        ...
        uint8_t  brake;                     // of type motor_speed_t
...
/* used in speed_dir_data_t */
typedef enum {
    TURN_FULL_LEFT          = 0x01,         // full left turn
    TURN_HALF_LEFT          = 0x02,         // half left turn
    TURN_SLIGHT_LEFT        = 0x03,         // slight left turn
    TURN_STRAIGHT           = 0x04,         // straight
